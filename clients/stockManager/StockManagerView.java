...
public class StockManagerView implements Observer
{
  ...
  private StockManagerController cont= null;
   ...
   */
  public StockManagerView(RootPaneContainer rpc, MiddleFactory mf, int x, int y )
  {
    try                                             // 
    {      
  ...
  {
    StockManagerModel model  = (StockManagerModel) modelC;
