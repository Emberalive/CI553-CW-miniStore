...
public class StockLoginView extends JFrame {
    ...
    StockLoginController controller = new StockLoginController(this, model, mlf);

    public StockLoginView() {
    ...
    public static void setController(StockLoginController controller) {
