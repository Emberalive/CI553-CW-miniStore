...
public class StockLoginModel extends Component {
    ...
    public void getAUser(String user, String password, StockLoginView view) throws SQLException {
        LoginDBAccess();
        String hashedPass;
    ...
    private void checkPassword (String bcryptHashString, String password, StockLoginView view) {
...
//    }
    ...
    public void startBackDoorGUI_MVC(MiddleFactory mlf)
    {
        ...
        BackDoorView view        = new BackDoorView( window, mlf, 400, 300 );
        ...
        pos.SetMonitorLocBackDoor(window);
